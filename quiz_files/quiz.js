(function($) {
    $.fn.jquizzy = function(settings) {
        var defaults = {
            questions: null,
            startImg: 'quiz_files/images/start.gif',
            endText: '已结束!',
            isFit: false,
            // shortURL: null,
            // sendResultsURL: null,
            resultComments: {
                perfect: '66666666 Linux Expert',
                excellent: '非常优秀!',
                good: '很好，发挥不错!',
                average: '一般般了。',
                bad: '太可怜了！',
        ...
        introFob = '	<div class="intro-container slide-container">Welcome!<br/>请选择学习模式<br/><br/><a class="nav-start" href="#"><span><p style="text-align:center;">固定难度</p><img src="'+config.startImg+'"></span></a><br/><a class="fit-start" href="#"><p style="text-align:center;">自动难度</p><span><img src="'+config.startImg+'"></span></a></div>	',
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
            ...
            degree.push(config.questions[questionsIteratorIndex].degree);
        }
        ...
        superContainer.find('#fixed').click(function() {
            superContainer.html(introFob + contentFob + exitFob);
            return false;
        });
        ...
        superContainer.find('.fit-start').click(function() {
            config.isFit = true;
            $(this).parents('.slide-container').fadeOut(500,
            function() {
                $(this).next().fadeIn(500);
        ...
        superContainer.find('.next').click(function() {
            ...
            if(config.isFit){
            this.count = 0; 
            var tempUserAsw = $(this).parents('.slide-container').find('li').index($(this).parents('.slide-container').find('li.selected')) +1 ;
        ...
        superContainer.find('li.selected').each(function(index) {
            ...
            // };
            for (var i = 0,
            // display the detail of every question in the result page
